...
- Lideré validación de accesibilidad en contextos diversos de literacidad de datos

*10+ Productos de analítica social y Aplicaciones de datos* \hfill 2023 – 2025

- Lideré el desarrollo de suite de visualización adoptada por 50% de clientes B2B, extendiendo LTV promedio de 12 a 16 meses usada por equipos de marketing en empresas multinacionales, equipos de análisis de redes sociales y departamentos de estrategia comercial
- Lancé MVP de clasificación IA de comentarios en 5 días usando RAG + ingeniería de prompts para una empresa internacional de comida rápida
- Co-definí y lideré UX research para app de logística de alimentos en el norte de México
